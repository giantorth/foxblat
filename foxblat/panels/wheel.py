...
from foxblat.bitwise import *
from foxblat.widgets import *

from foxblat.hid_handler import MozaAxis
...
class WheelSettings(SettingsPanel):
    ...
    def prepare_ui(self):
        ...
        paddle_mode = FoxblatToggleButtonRow("Dual Clutch Paddles Mode")
        ...
        level = FoxblatLevelRow("Combined Paddles", max_value=65535)
        self._add_row(level)
        ...
        self._add_row(FoxblatLevelRow("Left Paddle", max_value=65535))
        ...
        self._add_row(FoxblatLevelRow("Right Paddle", max_value=65535))
        ...
        slider = FoxblatSliderRow("Clutch Split Point", suffix="%", range_start=5, range_end=95)
        ...
        self._add_row(FoxblatToggleButtonRow("Rotary Encoder Mode"))
        ...
        self._stick_row = FoxblatToggleButtonRow("Left Stick Mode")
        ...
        self._add_row(FoxblatToggleButtonRow("Mode"))
        ...
        self._add_row(FoxblatSliderRow("Timeout minutes", 0, 30))
        ...
        self._add_row(FoxblatSliderRow("Blink interval (ms)", 125, 5000, increment=500))
        ...
        self._add_row(FoxblatNewColorPickerRow(pickers=1))
        ...
        self._combination_row = FoxblatDialogRow("Key Combination Settings")
        ...
        # tsw_buttons_active = FoxblatSwitchRow("TSW button colors", "Show additional row of color pickers")
        # tsw_buttons_active.subscribe(self._settings.write_setting, "tsw-button-colors")
        # self._add_row(tsw_buttons_active)

        calibration = FoxblatCalibrationRow("Calibrate Paddles", "Follow instructions here", alternative=True)
        ...
        self._add_row(FoxblatButtonRow("Restore default settings", "Reset"))
        ...
        self._add_row(FoxblatToggleButtonRow("Telemetry Mode"))
        ...
        self._add_row(FoxblatComboRow("Idle effect"))
        ...
        self._add_row(FoxblatNewColorPickerRow(blinking=True))
        ...
        self.add_preferences_group()
        self._add_row(FoxblatSliderRow("Brightness"))
        self._current_row.add_marks(25, 50, 75)
        ...
        self._blinking_row = FoxblatNewColorPickerRow()
        ...
        self.add_preferences_group()
        self._add_row(FoxblatButtonRow("Telemetry test", "Test"))
        self._current_row.subscribe(self.start_test)

        # self._add_row(FoxblatSliderRow("Flag Brightness", range_end=15))
        ...
        # self._add_row(FoxblatToggleButtonRow("RPM Indicator Display Mode"))
        ...
        # self._add_row(FoxblatToggleButtonRow("RPM Mode"))
        ...
        # self._timing_row = FoxblatEqRow("RPM Indicator Timing", 10, "Is it my turn now?",
        ...
        # self._add_row(FoxblatSliderRow("Blinking Interval", range_end=1000, subtitle="Miliseconds", increment=50))
        ...
        self._add_row(FoxblatButtonRow("Match with telemetry", "Match", "We are so in sync!"))
        ...
        # TSW Buttons
        self._add_row(FoxblatNewColorPickerRow(blinking=True, pickers=4))
    ...
    def _handle_tsw(self, value) -> None:
        ...
        if not self._tsw_row.get_present():
