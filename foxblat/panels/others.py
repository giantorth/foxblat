...
from foxblat.panels import SettingsPanel
...
class OtherSettings(SettingsPanel):
    ...
    def prepare_ui(self):
        ...
        self._add_row(FoxblatSwitchRow("Base Bluetooth", "For the mobile app"))
        ...
        self._add_row(FoxblatSwitchRow("Base FH5 compatibility mode", "Please, disable this on Linux"))
        ...
        self._add_row(FoxblatSwitchRow("Pedals FH5 compatibility mode", "Please, disable this on Linux"))
        ...
        self._add_row(FoxblatSwitchRow("Load default preset on application startup"))
        ...
        brake_row = FoxblatSwitchRow("Enable Brake Calibration", "Do it at your own risk")
        ...
        fix_row = FoxblatSwitchRow("Enable Moza detection fixes", "Not needed with Proton 10+")
        ...
        hidden = FoxblatSwitchRow("Start hidden")
        ...
        background = FoxblatSwitchRow("Run in the background")
        startup = FoxblatSwitchRow("Run on startup")
    ...
    def _autostart_native(self, enabled: bool) -> None:
        autostart_path = expanduser("~/.config/autostart/foxblat.desktop")
        if enabled:
