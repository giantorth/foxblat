...
class OldWheelSettings(SettingsPanel):
    ...
    def prepare_ui(self):
        ...
        self._add_row(FoxblatToggleButtonRow("RPM Indicator Mode"))
        ...
        self._add_row(FoxblatSliderRow("RPM Brightness", range_end=15))
        ...
        self.add_preferences_group()
        self._add_row(FoxblatButtonRow("Wheel indicator test", "Test"))
