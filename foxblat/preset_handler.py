...
MozaDevicePresetSettings = {
    ...
    "wheel-colors" : [
        ...
        "wheel-old-rpm-color1",
        "wheel-old-rpm-color2",
        "wheel-old-rpm-color3",
        "wheel-old-rpm-color4",
        "wheel-old-rpm-color5",
        "wheel-old-rpm-color6",
        "wheel-old-rpm-color7",
        "wheel-old-rpm-color8",
        "wheel-old-rpm-color9",
...
class MozaPresetHandler(SimpleEventDispatcher):
    ...
    def _save_preset(self):
        ...
        preset_data["FoxblatPresetVersion"] = "1"
        paddles = 0
